...
IFontDisp = Font
__all__ = [ 'FONTBOLD', 'OLE_CANCELBOOL', 'OLE_XPOS_PIXELS', 'IFont',
           'OLE_ENABLEDEFAULTBOOL', 'Picture', 'OLE_XSIZE_HIMETRIC',
           'IFontEventsDisp', 'OLE_XPOS_CONTAINER',
           'LoadPictureConstants', 'OLE_OPTEXCLUSIVE',
           'OLE_XSIZE_PIXELS', 'Unchecked', 'OLE_YSIZE_HIMETRIC',
           'OLE_XSIZE_CONTAINER', 'FONTNAME', 'Checked', 'FONTITALIC',
           'Font', 'OLE_YSIZE_CONTAINER', 'Gray', 'Default',
           'VgaColor', 'OLE_YSIZE_PIXELS', 'FONTSIZE', 'Monochrome',
           'StdFont', 'OLE_YPOS_PIXELS', 'IFontDisp',
           'OLE_XPOS_HIMETRIC', 'IPictureDisp', 'FONTSTRIKETHROUGH',
           'StdPicture', 'FONTUNDERSCORE', 'FontEvents', 'OLE_COLOR',
           'OLE_HANDLE', 'OLE_YPOS_CONTAINER', 'Color',
           'OLE_YPOS_HIMETRIC', 'OLE_TRISTATE', 'IPicture']
from comtypes import _check_version; _check_version('1.1.10', 1552970625.570791)
